  ...
  routes: [
    {
      ...
      component: Home,
      children:[
		      {path: '/Home/css3',name: 'css3', redirect:'/Home/css3/Title', component: () => import('./views/Myitem/css3.vue'),
		            children:[
		            {path: '/Home/css3/Title',name: 'Title',component: () => import('./views/Myitem/CSS3-Item/Title.vue')},
		            {path: '/Home/css3/Other',name: 'Other',component: () => import('./views/Myitem/CSS3-Item/Other.vue')}
		            ]
		      },
